...
class SchemeUnlockMechanism extends UnlockMechanism {
  ...
  Future<
    ...
    if (policy.vaultUnlockAdditionalData['scheme'] != null) {
      return Future.value((
        SecretKey(
            passwordToCryptKey(policy.vaultUnlockAdditionalData['scheme'])),
        'OK',
        <String, dynamic>{}
      ));
    }
    return Future.value((
      null,
      S.of(context).errorChestSchemeShouldNotBeEmpty,
      <String, dynamic>{}
    ));
  }
...
class PatternFormField extends FormField<String> {
  PatternFormField(
      ...
      : super(
            ...
            builder: (state) {
              return PatternLock(
                  onInputComplete: (List<int> completedPattern) {
