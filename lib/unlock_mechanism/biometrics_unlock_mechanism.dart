...
class BiometricsUnlockMechanism extends UnlockMechanism {
  ...
  void build(
    ...
    String? encryptedString =
        VaultsManager.globalAdditionalUnlockData['biometrics']['globalKey'];
      ...
      try {
        ...
        if (e.code != 'E05') {
          ...
          ScaffoldMessenger.of(context)
              .showSnackBar(SnackBar(content: Text(S.of(context).wrongDevice)));
  ...
  Future<
    ...
    BiometricPromptInfo promptInfo = BiometricPromptInfo(
        ...
        negativeButton: S.of(context).cancel,
        description: S.of(context).unlockChest);
    if (!VaultsManager.globalAdditionalUnlockData.containsKey('biometrics') ||
        !VaultsManager.globalAdditionalUnlockData['biometrics']
      ...
      VaultsManager.globalAdditionalUnlockData['biometrics']['globalKey'] =
          await localAuthCryptoInstance.encrypt(plainKey);
    }

    try {
      String? plainKey = await localAuthCryptoInstance.authenticate(promptInfo,
          VaultsManager.globalAdditionalUnlockData['biometrics']['globalKey']);

      return (SecretKey(plainKey!.codeUnits), 'OK', <String, dynamic>{});
    } on PlatformException catch (e, st) {
    ...
    return (null, 'Authentication error', <String, dynamic>{});
  }
  ...
  Widget keyCreationBuild(BuildContext context, VaultPolicy policy) {
    return ListTile(
        ...
        title: Text(S.of(context).biometricsAreLocal,
