...
class DocumentViewer extends StatefulWidget {
  ...
  const DocumentViewer({super.key, required this.fileVault, required this.fileToRead, required this.fileName});
...
class DocumentViewerState extends State<DocumentViewer> {
  ...
  @override
  void initState() {
    documentType = basename(widget.fileName).endsWith('pdf') ? DocumentType.pdf : DocumentType.plainText;
    super.initState();
  }
